...
public class Example11SessionAttributes {
  ...
  // This is a first step in multistep address submission
  ...
  // This is a post submission method for first step of multistep address submission
  @PostMapping("/example11/address/step1")
  public String example11Step1(@ModelAttribute("person") @Valid Person person,
                               BindingResult bindingResult) {
    return bindingResult.hasErrors() ? "address-form-step1" : "redirect:/example11/address/step2";
  }
  ...
  public String example11Step2(@ModelAttribute("shortAddress") @Valid ShortAddress shortAddress,
                               BindingResult bindingResult) {
    return bindingResult.hasErrors() ? "address-form-step2" : "redirect:/example11/address/step3";
  }
  ...
  public String example11Step3(@ModelAttribute("country") @Valid Country country,
                               BindingResult bindingResult,
