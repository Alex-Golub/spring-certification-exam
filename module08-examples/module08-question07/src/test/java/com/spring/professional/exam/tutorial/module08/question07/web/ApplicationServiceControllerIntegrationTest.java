...
public class ApplicationServiceControllerIntegrationTest {
  ...
  public void shouldBookRoomForRegisteredGuest() throws Exception {
    ...
    mockMvc.perform(put(API_BOOKINGS).contentType(APPLICATION_JSON)
                                     .content(bookingRequestJson.write(new BookingRequest(registeredGuest, DATE_2020_JULY_20)).getJson()))
           .andExpect(status().isOk());
