...
/**
 * If multiple DB, entities and transactions are used in app then roll-back
 * functionality should be enabled thus use JtaTransaction rather then JpaTransaction
 */
@Configuration
