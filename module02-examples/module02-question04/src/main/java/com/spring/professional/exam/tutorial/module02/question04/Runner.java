...
//    employeeRepository.deleteEmployee(new Employee());
    ...
    // deleteByEmail is not part of the interface contract thus it is not proxied
...
//    alternateEmployeeRepository.deleteEmployee(new Employee()); // if method is final aspect can't be injected because methods can't be overridden
...
//    samePackageEmployeeRepository.deleteEmployeeByEmail("john@corp.net");
    ...
    /*
     * private method will be invoked but aspects will not be applied because
     * CGLIB proxy object can't override this method because its private
     */
