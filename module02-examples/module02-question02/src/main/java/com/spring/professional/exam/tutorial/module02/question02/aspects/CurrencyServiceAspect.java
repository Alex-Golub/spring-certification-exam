...
public class CurrencyServiceAspect {
  ...
  /**
   * When getExchangeRate(..) is invoked from the external (JoinPoint)
   * this PointCut is matched and getExchangeRateMethodPointcut() is executed
   */
  ...
  /**
   * When getExchangeRateMethodPointcut() is executed this code block will be injected before and after
   * getExchangeRateMethodPointcut() code execution.
   * This code injection is called Advice
   */
