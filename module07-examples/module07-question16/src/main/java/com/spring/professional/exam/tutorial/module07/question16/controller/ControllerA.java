...
public class ControllerA {
  ...
  // Using model and view (model is the object that will be referenced from the view
  // to resolve the values from the Java object). Name of the model the
  // name of the attribute we assign in the addAttribute() method
