...
public class ApiControllerTest {
  ...
  public void shouldListCustomersAsEntity() {
    ...
    assertThat(Objects.requireNonNull(entity.getBody()).getCustomers()).containsExactly(
            CUSTOMER_1,
            CUSTOMER_2,
            CUSTOMER_3
    );
  ...
  public void shouldFindCustomersWithLetterAInFirstName() {
    ...
    assertEquals(HttpStatus.OK, customersEntity.getStatusCode());
    assertThat(Objects.requireNonNull(customersEntity.getBody()).getCustomers()).containsExactly(
            CUSTOMER_1,
            CUSTOMER_2
    );
  }
  ...
  public void shouldNotFindAnyCustomers() {
    ...
    assertEquals(HttpStatus.NOT_FOUND, customersEntity.getStatusCode());
