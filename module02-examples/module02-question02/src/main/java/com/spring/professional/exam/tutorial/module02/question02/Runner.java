...
public class Runner {
  public static void main(String[] args) throws InterruptedException {
    ...
    currencyService.getExchangeRate("EUR", "USD"); // getExchangeRate(String, String) is JoinPoint in AOP
    currencyService.getExchangeRate("EUR", "USD", 100);
    currencyService.getCurrencyLongName(CurrencyId.EUR); // getCurrencyLongName(CurrencyId) is also JoinPoint
    try {
