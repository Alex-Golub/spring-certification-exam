...
import com.spring.professional.exam.tutorial.module02.question07.beans.EmployeeBean;
...
//    ITaxBean taxBean1 = context.getBean(ITaxBean.class); // JdkProxy will be created for ITaxBean impl class
//    TaxBean2 taxBean2 = context.getBean(TaxBean2.class); // CGLIB proxy object will extend TaxBean2
