...
@Configuration
@EnableConfigurationProperties(MySqlProperties.class) // allow additional configuration to be preformed
@PropertySource("classpath:mysql.properties") // NOTE: properties is found in the consuming module
