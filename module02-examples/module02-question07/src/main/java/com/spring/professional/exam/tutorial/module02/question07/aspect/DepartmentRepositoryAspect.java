...
public class DepartmentRepositoryAspect {
  ...
  public void annotationWithinExample() {
    System.out.println("Before - @within(com.spring.professional.exam.tutorial.module02.question07.annotation.MonitoredRepository)");
  }
  ...
  public void annotationTargetExample() {
    System.out.println("Before - @target(com.spring.professional.exam.tutorial.module02.question07.annotation.MonitoredRepository)");
  }
}
