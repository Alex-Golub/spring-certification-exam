...
public class EmployeeBeanAspect {
  @Before("execution(* com.spring.professional.exam.tutorial.module02.question07.beans.EmployeeBean.get*()) || " +
          "execution(* com.spring.professional.exam.tutorial.module02.question07.beans.EmployeeBean.set*(*))")
