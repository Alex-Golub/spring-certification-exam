...
// SessionStatus + class-level @SessionAttributes with multistep form processing
@Controller
...
public class Example16SessionAttributes {
  ...
  public String actionPStep1(@ModelAttribute("person") @Valid Person person,
  ...
  public String actionPStep2(@ModelAttribute("shortAddress") @Valid ShortAddress shortAddress,
                             BindingResult bindingResult) {
    if (bindingResult.hasErrors())
      return "address-form-step2";
    else
  ...
  public String actionPStep2(@ModelAttribute("country") @Valid Country country,
                             BindingResult bindingResult,
