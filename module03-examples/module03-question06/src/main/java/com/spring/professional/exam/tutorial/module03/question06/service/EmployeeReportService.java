...
public class EmployeeReportService {
    ...
    /**
     * Each call to findEmployeesCount() method is a standalone transaction i.e. transactions are sequential
     */
    ...
    /**
     * Using the @Transactional the transactions are all "gather" to one transaction and will
     * be preformed as one unit if some transaction will fail roll-over will be preformed
     * i.e. neither transaction will not be executed
     */
    @Transactional
