...
public class Example18AnyType {
  ...
  // firstName is mapped to firstName of the method same as writing
  // @RequestParam String firstName
  @GetMapping("/actionS")
  @ResponseBody
  public String actionS(/*@RequestParam*/ String firstName,
  ...
  // person as treated as ModelAttribute thus form mapped to Person object
