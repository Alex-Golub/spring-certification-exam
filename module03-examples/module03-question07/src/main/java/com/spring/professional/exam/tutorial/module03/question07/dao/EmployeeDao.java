...
public class EmployeeDao {
    ...
    public String findEmployeeEmail(int id) {
        return jdbcTemplate.queryForObject("select email from employee where employee_id = ?", new Object[]{id},
                                           String.class);
    }
    ...
    public Employee findEmployee(int id) {
        return jdbcTemplate.queryForObject(
                ...
                new Object[]{id}, this::mapEmployee); // provide custom EEmployee mapper instead of the default JdbcTemplate mapper
    }
